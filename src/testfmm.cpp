...
void Apply (const Array<Vec<3>> & ptx,
            const Array<Vec<3>> & pty,
            FlatVector<> x, FlatVector<> y)
{
  y = 0;
...
int main()
{
  ...
  auto fmm = laplace_blas_f64(expansion_order.Data(),
